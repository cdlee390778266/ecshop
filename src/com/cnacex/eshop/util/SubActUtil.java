...
public class SubActUtil extends KVUtil {
	
	private static Logger logger = LoggerFactory.getLogger(SubActUtil.class);

	public static Hashtable<String, String> hashtable = new Hashtable<String, String>();

	static {
		loadXmlFile("subacttype", hashtable);
		
		logger.info("加载子账户类型映射数据个数 {}", hashtable.size());
	}
