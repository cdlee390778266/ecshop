...
public class DeliveryController extends TradeController{
	...
	public String selllist(
			@RequestParam(value = "type", required = true, defaultValue = "S") String type,
	...
	public @ResponseBody HashMap<String, Object> findDeList(
			@RequestParam(value = "type", required = true) String type,
			@RequestParam(value = "code", required = false) String code,
			@RequestParam(value = "status", required = false) String status,		
			@RequestParam(value = "strikeNo", required = false) String strikeNo,		
	...
	public @ResponseBody
	JSonComm appeal(
			@RequestParam(value = "strikeNo", required = true) String strikeNo,
		...
		CommRspMsg commRspMsg = deliveryService.deliveryAppeal(appealReq);
	...
	public String deliverPay(
			@PathVariable("strikeNo") String strikeNo, ModelMap model) {
	...
	public @ResponseBody
	JSonComm findAppealContext(
			@RequestParam(value = "compno", required = true) String compno) {
