...
<body>
	...
	<div class="wrapper service-full mt30">
		<div class="grid-16-16">
			<div class="crumb-nav">
				<div class="crumb">
					<a href="/home.htm">交易大厅</a><span class="fa  fa-angle-right"></span><a href="/mall/list.htm">我的挂牌</a><span class="fa  fa-angle-right"></span><a href="javascript: void(0)">卖方挂牌</a>
				</div>
			</div>
								...
								<div class="bd">
									...
									<tbody>
										...
										<tr>
											...
											<td>${rspBody.className}&gt;${rspBody.commName} <span  class="fcyellow"> (${rspBody.title})</span></td>
										</tr>
                                         	 ...
                                         	 <td>
	                                            	<c:choose>
										   				<c:when test="${rspBody.delist=='A'}">  
										   					...
										   					<div style="width:700px; height:120px; overflow:auto; border:1px solid #89C975;">									   			
										   						<ul>
										   						<c:forEach items="${rspBody.delistMems}" var="dm" >	
										   							<li style="float: left; width: 330px;text-align: left; overflow: hidden;margin:0 5px;padding: 2px 0; text-overflow: ellipsis;">${dm.delistMemName}</li>								   						
										   						</c:forEach>
										   						</ul>	
										   					</div>								   					
										   				</c:when>
                                        ...
                                        <tr>
                                            ...
                                            <div class="clearfix ml20">                                                
	                                            <c:if test="${fn:length(rspBody.ctxPic1)>0}">  
	                                            	<img id="imgCtxPic1Pre" src="${rspBody.ctxPic1}" style="display: block;float:left" class="ml10" width="200px" height="200px"  />
	                                            </c:if>
	                                            <c:if test="${fn:length(rspBody.ctxPic2)>0}">
	                                            	<img id="imgCtxPic1Pre" src="${rspBody.ctxPic2}" style="display: block;float:left" class="ml10" width="200px" height="200px"  />
	                                            </c:if>                                         
	                                            <c:if test="${fn:length(rspBody.ctxPic3)>0}"> 
	                                        		<img id="imgCtxPic1Pre" src="${rspBody.ctxPic3}" style="display: block;float:left" class="ml10" width="200px" height="200px"  />
	                                       		 </c:if> 
                                       		 </div>  
                                            </td>
                                        </tr> 
                                        ...
                                        <c:if test="${operType=='A'}"> 	  	                                      	                                        
	                                        <tr>
	                                            ...
	                                            <td><input type="radio" name="auditRet" id="auditRet" value="1"  checked />审核通过   
	                                                <input type="radio" name="auditRet" id="auditRet" value="0" />不审核通过 </td>                          
	                                        </tr>
