		...
		<table class="ui-table table-primary">
			...
			<tbody>
				...
				<tr>
					...
					<td class="fcyellow"><fmt:formatNumber value="${cost.costAmt}" type="currency" pattern="￥0.00元" /></td>
					<td>${cost.flagDesc}</td>
				</tr>
			</c:forEach>
		</tbody>
...
<div class="row bsrow">
	<form name="buyform" id="buyform" method="post" action="/buy/${link}.htm" >
		...
		<c:if test="${operType=='P'}"> 	  	                                      	                                        	  <table class="ui-table bstable pay-table mart20">                                      
		<tr>
