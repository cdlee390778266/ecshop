		...
		<div class="login-af clearfix">
			...
			<!-- 		<li class="uitem">
				...
				<li class="uitem dropdown">
					<a href="javascript:;" class="dcell n" style="border-bottom:1px solid transparent"><img src="/images/user.png" alt="" class="dropdown-face" />会员中心<span class="fa fa-angle-down"></span></a>
					<div class="dbox dmember padt20">
						<div class="user-face fl">
							<img src="/images/face.png" alt="" class="mart10" />
						</div>
						<div class="dlData fl">
						<div class="dlTitle">
