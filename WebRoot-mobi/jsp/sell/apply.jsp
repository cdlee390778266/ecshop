...
<link type="text/css" rel="stylesheet"
	href="/widget/css/ui.datepicker.css" />
...
<script type="text/javascript"
	src="/js/handle.sell.apply.js?v=${sessionScope.buildno}"></script>
							...
							<div class="page-module warehouse">
								<div class="row">
									...
									<div style="margin: 20px 20px 20px 0px;">
										<a href="/sell/apply.htm?active=enter&type=0" style="text-decoration: none;border: 1px solid #049019;color: #FFFFFF;background-color: #89C975;padding: 10px;">保证金</a>
										<a href="/sell/apply.htm?active=enter&type=1" style="text-decoration: none;border:1px solid #ECECEC;padding: 10px;margin-left: 10px;">注册仓单</a>		
									</div>
									<div class="bd">
										<table class="ui-table">
											...
											--></td>
												...
												<tr>
													...
													<td>
														<div class="form_control">
															<input type="text" name="qty" id="qty" class="required"
													...
													<td>
														<div class="J_WholeFlag">
															<span class="ml20 mr20"><input type="radio"
																name="wholeFlag" id="w_flag" value="W" />是</span> <span><input
																type="radio" name="wholeFlag" id="s_flag" value="S"
																checked />否</span>
														</div>
													...
													<td>
														<div class="form_control">
															<input type="text" name="incrNum" id="incrNum"
																class="required" data-tip="请输入商品递增量"
																data-valid="isNonEmpty||plusInt"
											...
											<span><input type="checkbox" name="mart" value="E" >专有专场</span>
											 --></td>
												...
												<tr>
													...
													<td><select style="width: 230px; margin-left: 10px"
