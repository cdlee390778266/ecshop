								...
								<div class="pa-gallery">
									...
									<div class="pa-booth pa-pic">
										...
										<a href="${rspBody.titlePic}" id="zoom1" rel="nofollow" class="MagicZoom MagicThumb" target="_blank">     
											<img id="J_ImgBooth" src="${rspBody.titlePic}" width="200px" height="200px"  onError="this.src='/mobile/images/loadfail.jpg'" >
										</a>
									</c:if>
									<c:if test="${fn:length(rspBody.titlePic)<= 0}">   
									<img  src="/mobile/images/loadfail.jpg" width="200px" height="200px" >
								</c:if>																				 
							</div>
						</div>
					</div>
...
<div id="description" class="ke-post J_DetailSection"> 
	...
	<p style="margin-top:20px;text-align:center;">
		...
		<c:if test="${fn:length(rspBody.ctxPic1)>0}"> 
		<img src="${rspBody.ctxPic1}" alt="" onError="this.src='/mobile/images/loadfail.jpg'" >
	</c:if>

	<c:if test="${fn:length(rspBody.ctxPic2)>0}"> 
	<img src="${rspBody.ctxPic2}" alt="" onError="this.src='/mobile/images/loadfail.jpg'" >
</c:if>

<c:if test="${fn:length(rspBody.ctxPic3)>0}"> 
<img src="${rspBody.ctxPic3}" alt="" onError="this.src='/mobile/images/loadfail.jpg'" >
</c:if>
