			...
			<div id="step3" >
				...
				<div class="form-group buy-group">
					<div class="input-group rel">
						...
						<input type="text" name="doe" id="doe" data-min="${busDate}" class="required form-control  txtright" data-tip="请选择挂牌有效期" data-valid="isNonEmpty||isDate||after:${busDate}" data-error="挂牌有效期必填||有效期格式不正确||有效期小于业务日期${busDate}" readonly="readonly" />
					</div>
				</div>
