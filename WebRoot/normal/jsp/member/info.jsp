									...
									<form id="memberform" action="/member/info.htm" method="post" enctype="multipart/form-data">
										...
										<div><strong>我的头像：</strong>
											<div class="clearfix mart20">
												<img id="operPhotoPre" src="${(fn:length(user.operPhoto)==0 || empty user.operPhoto)?'/normal/images/portrait.jpg':user.operPhoto}" width="120px" height="120px" style="display: block;float:left" />
