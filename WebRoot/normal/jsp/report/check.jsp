...
<script type="text/javascript" src="/normal/js/tableselect.js"></script>
			...
			$.ajax({
						...
						success : function(data) {
							if(data.succflag != 0){
								...
								$('#headrender').html('<div class="title">'+data.mid+'交易商对账单</div>');
					...
					<div class="bd">
						...
						<div class="page-module data-rpt">
							<div class="row">
								...
								<div class="row clearfix mt10 export-bar">
