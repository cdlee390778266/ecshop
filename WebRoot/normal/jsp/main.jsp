...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/normal/css/selecttags.css?v=${sessionScope.buildno}" >
    ...
    <script type="text/javascript" src="/normal/js/selecttags.js?v=${sessionScope.buildno}"></script>
