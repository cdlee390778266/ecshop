			...
			<div class="crumb-nav">
				<div class="crumb">
					...
					<span class="fa  fa-angle-right"></span><a
						href="javascript: void(0)" class="fc999">商品信息</a>
				</div>
			</div>
											...
											<div class="property">
												<div class="pa-wrap">
													<div class="pa-wrap-x">
														<div class="pa-title">
															<h3>
																<strong class="product-name">${rspBody.commName}
																</strong><span>${rspBody.title}</span>
																<c:if test="${enableBuy=='true'}">
																	<div class="pa-action fr">
																		<div class="pa-btn-buy fn-fl">
																			<a href="/buy/prepare/${rspBody.listedNo}.htm"
																				class="btn-normal btn-buy">立即购买</a>
																		</div>
																	</div>
																</c:if>
															</h3>
														...
														<div class="product-bar">
															单价：<span class="price marr30"><small>￥</small>
															<fmt:formatNumber value="${rspBody.up}" type="currency"
																	pattern="0.00元" />/${rspBody.uom}</span> 数量（剩余数量/总数量）：<span
																class="fnt-bnd"> <span class="fs18"><span
																	class="fcyellow">${rspBody.rem}</span>/${rspBody.qty}</span>
																${rspBody.uom}
															</span>
														</div>
													...
													<div class="mod-tabbar up-tabbar">
														<ul class="pa-tabbar pdeta" id="J_TabBar">
															<li class="item tab-cell selected"><a
																href="javascript:void(0);" hidefocus="true">商品信息</a></li>
															<li class="item tab-cell"><a
																href="javascript:void(0);" hidefocus="true">商品描述</a></li>
															<li class="item tab-cell"><a
																href="javascript:void(0);" hidefocus="true">商品图片描述</a></li>
															<c:if
																test="${rspBody.delist=='A' && rspBody.mID == sessionScope.userinfo.mID}">
																<li class="item tab-cell"><a
																	href="javascript:void(0);" hidefocus="true">指定摘牌方</a></li>
															</c:if>
													...
													<div class="tab-content" style="display: none;">
														<p style="margin-top: 20px; text-align: center;">
															...
															<c:if test="${fn:length(rspBody.ctxPic1)>0}">
																<img src="${rspBody.ctxPic1}" alt=""
																	onError="this.src='/normal/images/loadfail.jpg'">
															</c:if>

															<c:if test="${fn:length(rspBody.ctxPic2)>0}">
																<img src="${rspBody.ctxPic2}" alt=""
																	onError="this.src='/normal//images/loadfail.jpg'">
															</c:if>

															<c:if test="${fn:length(rspBody.ctxPic3)>0}">
																<img src="${rspBody.ctxPic3}" alt=""
																	onError="this.src='/normal//images/loadfail.jpg'">
															</c:if>
