...
<body>
	...
	<div class="wrapper service-full mt30">
		<div class="grid-16-16">
			...
			<div class="curmbs mart20 gp cd-gp">
				<ul>
					<li><a href="javascript:void(0);" id="step1-notice" class="active"  ><img src="/normal/images/step-success.png" alt="" style="display:inline-block;" />1 选择挂牌方式及仓单编码</a></li>
					<li><a href="javascript:void(0);" id="step3-notice" ><img src="/normal/images/step-success.png" alt="" />2 设置交易方式</a></li>
					<li><a href="javascript:void(0);" id="step4-notice"><img src="/normal/images/step-success.png" alt="" />3 商品描述及确认挂牌</a></li>
				</ul>
			</div>
						...
						<div class="gp-box">
							...
							<div class="gp-step1 step-pad ">
								<div class="gp-step1-main txtcenter">
									...
									<div class="select-box">
										...
										<div class="input-group ">
											<div class="group-box trade-promise">
												<span class="val"><span >仓单</span><i></i></span>
												<ul style="display: none;" id="tradeType">
													<li value="M" data-href="/sell/apply.htm?active=enter&type=0">保证金</li>
									...
									<div class="select-box" id="product-dialog1">
										<div class="select-title">
											注册仓单编码：
										</div>
