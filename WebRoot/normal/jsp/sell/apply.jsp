...
<head>
  ...
  <script type="text/javascript" src="/normal/js/handle.sell.apply.js?v=${sessionScope.buildno}"></script>
...
<body>
 ...
 <div class="wrapper service-full mt30">
  <div class="grid-16-16">
   <div class="crumb-nav">
    <div class="crumb">
     <a href="/home.htm">交易大厅</a><span class="fa  fa-angle-right"></span><a href="/sell/apply.htm?active=enter">买卖菜单</a><span class="fa  fa-angle-right"></span><a href="/sell/apply.htm?active=enter&type=0">我要挂牌</a>
   </div>
 </div>
 <div class="curmbs mart20 gp">
  <ul>
    <li><a href="javascript:void(0);" id="step1-notice"  ><img src="/normal/images/step-success.png" alt="" style="display:inline-block;" />1 选择挂牌方式及具体商品</a></li>
    <li><a href="javascript:void(0);" id="step2-notice"><img src="/normal/images/step-success.png" alt="" />2 填写商品属性</a></li>
    <li><a href="javascript:void(0);" id="step3-notice" ><img src="/normal/images/step-success.png" alt="" />3 设置交易方式</a></li>
    <li><a href="javascript:void(0);" class="active" id="step4-notice"><img src="/normal/images/step-success.png" alt="" />4 商品描述及确认挂牌</a></li>
  </ul>
</div>
