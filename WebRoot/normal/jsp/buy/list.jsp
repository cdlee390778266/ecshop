...
<head>
	...
	<script type="text/javascript" src="/normal/js/handle.buy.js?v=${sessionScope.buildno}"></script>
	<title>采购清单</title>
	...
	<table class="ui-table table-primary">
		...
		<tbody>
			...
			<tr class="{{setstyle @index}}">
				<td><div class="pic"><img src="{{titlePic}}" width="80px" height="80px" alt="" onError="this.src='/normal/images/loadfail.jpg'"></div></td>
