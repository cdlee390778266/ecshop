...
<head>
	...
	<script type="text/javascript" src="/js/handle.delivery.sell.js?v=${sessionScope.buildno}"></script>
    <title>交收管理</title>
		...
		<table class="ui-table table-primary">
            ...
            <tbody>
                {{#strikes}}
					...
					<tr class="{{setstyle @index}}">
						<td>
							<div class="pic"><img src="{{titlePic}}" width="53" height="53" alt="" onError="this.src='/images/loadfail.jpg'"></div>
						</td>
						<td>
