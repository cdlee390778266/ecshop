...
<head>
    ...
    <script type="text/javascript" src="/js/handle.mall.js?v=${sessionScope.buildno}"></script>
    <title>我的挂牌</title>
									...
									<table class="ui-table">
										<tbody>
											...
											<tr>
												...
												<td><input type="text" name="doe" id="doe" datepicker data-date-format="yyyy-mm-dd" data-auto-close="true"  class="cinp-date ml10" />												
												<td class="ctr">状态：</td>
												<td>												
